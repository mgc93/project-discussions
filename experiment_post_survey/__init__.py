...
class Player(BasePlayer):
    ...
    conv_satisfied        = models.IntegerField(min=1, max=5)  # Overall satisfaction
    conv_feeling_heard    = models.IntegerField(min=1, max=5)  # Feeling heard
    conv_voice            = models.IntegerField(min=1, max=5)  # Voice / psychological safety
    conv_understanding    = models.IntegerField(min=1, max=5)  # Understanding the other person
    conv_receptiveness    = models.IntegerField(min=1, max=5)  # Good faith / receptiveness
    conv_respect          = models.IntegerField(min=1, max=5)  # Respect
    conv_future_engage    = models.IntegerField(min=1, max=5)  # Future engagement

    # Affect — separate page
    ...
    fac_warmth           = models.IntegerField(min=1, max=5)  # Warmth
    fac_competence       = models.IntegerField(min=1, max=5)  # Competence
    fac_legitimacy       = models.IntegerField(min=1, max=5)  # Legitimacy
    fac_fairness         = models.IntegerField(min=1, max=5)  # Fairness
    ...
    fac_willingness      = models.IntegerField(min=1, max=5)  # Willingness to engage
...
class ConversationSurvey(Page):
    ...
    def vars_for_template(player):
        ...
        questions = [
            ...
            dict(field='conv_understanding', label="By the end, I felt I understood the other person's perspective."),
